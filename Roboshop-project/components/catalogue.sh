...
INFO "Setup Catalouge Component"

INFO "Install Nodejs"
you install nodejs make gcc-c++ -y &>>$LOG_FILE
...
sed -i -e "s/MONGO_DNSNAME/mongodb-test.devopsb53.tk/"
  /home/roboshop/catalogue/systemd.service
STAT $? "Startup script configuration"

INFO "Setup SyatemD Service for Catalogue"
